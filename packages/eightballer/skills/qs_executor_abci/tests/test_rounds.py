...
"""This package contains the tests for rounds of QSExecutor."""
...
class BaseQSExecutorRoundTest(BaseRoundTestClass):
    """Base test class for QSExecutor rounds."""
...
class TestAwaitBuyerTransactionsRound(BaseQSExecutorRoundTest):
    """Tests for AwaitBuyerTransactionsRound."""

    round_class = AwaitBuyerTransactionsRound
...
class TestAwaitRFQsRound(BaseQSExecutorRoundTest):
    """Tests for AwaitRFQsRound."""

    round_class = AwaitRFQsRound
...
class TestCollectExchangeDataRound(BaseQSExecutorRoundTest):
    """Tests for CollectExchangeDataRound."""

    round_class = CollectExchangeDataRound
...
class TestPostTransactionRound(BaseQSExecutorRoundTest):
...
class TestPrepareClaimTransactionsRound(BaseQSExecutorRoundTest):
...
class TestPrepareRefundTransactionsRound(BaseQSExecutorRoundTest):
...
class TestPrepareSupplyTransactionRound(BaseQSExecutorRoundTest):
    """Tests for PrepareSupplyTransactionRound."""

    round_class = PrepareSupplyTransactionRound
